...
// CustomerCubit manages business logic for Customer operations
class CustomerCubit extends Cubit<CustomerState> {
  ...
  // Set up real-time stream subscription to the repository
  ...
  // Refilter and emit Loaded state
  ...
  // Search filter triggered by search textfield changes
  ...
  // Force pull-to-refresh: re-subscribes to clean stream
  Future<void> refreshCustomers() async {
    _subscribeToCustomers();
    // Small delay to show pull-to-refresh loading indicator
